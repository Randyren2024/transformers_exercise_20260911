...
OUT_DIR = DRIVE / "artifacts" / "step63"
...
def main():
    ...
    print("Train QA rows:", len(train_rows))
    print("Validation QA rows:", len(val_rows))
    print("Train groups:", len(train_groups), "| Validation groups:", len(val_groups))
    print("Starting from:", BASE_CKPT)
    print("Objective: answer-only CE + ranking + teacher KL + small raw-LM preservation")
    ...
    for step in range(1, args.steps + 1):
        ...
        if step % 200 == 0 or step == args.steps:
            ...
            print(
                f"held-out validation: good-NLL={good_nll:.4f} | "
